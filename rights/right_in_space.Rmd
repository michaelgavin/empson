...
However, when rights were actually invoked, they were nearly always invoked in the context of their `violation`, `invasion`, or `usurpation`. Words syntagmatically similar to `rights` suggest an almost paranoid fear of infringement. The `liberties` and the `prerogatives` of the powerful were under constant threat, it seems, giving lie to the optmistic but isolated assertion that rights could be `undoubted`. There's nothing *self-evident* about rights like these. 
...
Component-wise multiplication, on the other hand, strips away most of this baggage and leaves in place only the terms held in common by all the words in a given statement. Rather than reflecting the common assumptions used to bring the words together, multiplication reveals what's at stake, or what's potentially suprising, about their combination. Whereas addition reveals a statement's most important unstated assumptions, multiplication reveals its most important unstated goals.

*Full disclosure: I'm on very shaky ground here. Connecting quantitative to qualitative analysis is always tricky business, and de Bolla provides few hints about what patterns of collocation might correspond to what kinds of conceptual relation. Computational linguists, as far as I know, have not used their techniques to tease apart the assumptions of complex, centuries-old philosophical discourse, and they differ over the question of how "attributional similarity" -- that is, the similarity of any two vectors' attributes -- can be correlated to "relational similarity" that places words in concepts. I feel pretty confident about what I've said so far; what follows is more experimental and tentative, and I'm sure it will require later revision and qualification.*
