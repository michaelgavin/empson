...
- Installing `empson` (and, optionally, `tei2r`)
- Sample datasets
...
Because `empson` and `tei2r` both include significantly large datasets, the download and installation may take a minute or two. Once installed, add to your library:
