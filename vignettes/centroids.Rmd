...
If we examine the passage from which the first two instances of **wit** are drawn, we see a perhaps surprising disjunction between the apparent meanings and the results of the centroid analysis. The centroids emphasize **wit**'s association with embodied cognition and their corrupted state when compared to the divine.
